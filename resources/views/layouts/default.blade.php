          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                  ...
                  <li{!! (Request::query('status') == 'Undeployable' ? ' class="active"' : '') !!} ><a href="{{ url('hardware?status=Undeployable') }}"><i class="fa fa-circle-o text-red"></i>
                  ...
                  <li{!! (Request::query('status') == 'Archived' ? ' class="active"' : '') !!}><a href="{{ url('hardware?status=Archived') }}"><i class="fa fa-circle-o text-yellow"></i>
